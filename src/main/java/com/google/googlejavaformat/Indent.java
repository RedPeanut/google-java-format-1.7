...
/**
 * An indent for a {@link Doc.Level} or {@link Doc.Break}. The indent is either a constant {@code int}, or a conditional
 * expression whose value depends on whether or not a {@link Doc.Break} has been broken.
 */
