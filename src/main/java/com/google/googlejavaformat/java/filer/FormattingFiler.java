...
/** A decorating {@link Filer} implementation which formats Java source files with a {@link Formatter}. */
public final class FormattingFiler implements Filer {
	...
	/**
	 * Create a new {@link FormattingFiler}. An optional {@link Messager} may be specified to make logs more visible.
	 *
	 * @param delegate filer to decorate
