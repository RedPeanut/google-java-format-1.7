...
public class RemoveUnusedImports {
	...
	@Deprecated
	public static String removeUnusedImports(final String contents, JavadocOnlyImports javadocOnlyImports)
	...
	public static String removeUnusedImports(final String contents) throws FormatterException {
		...
		// TODO(cushon): this should default to the latest supported source level, same as in
		// Formatter
